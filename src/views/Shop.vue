            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        contact@lorem-ipsum.info </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="button" data-dismiss="modal" data-toggle="modal" data-target="#exampleModal" class="btn btn-primary">Continue</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col mb-3">
                    ...
                    <div class="card h-100 mb-0">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary" data-dismiss="modal" data-toggle="modal" data-target="#exampleModalLong"><i class="fas fa-scroll"></i> Submit Order</button>
                        </div>
                ...
                <div class="col mb-3">
                    ...
                    <div class="card h-100 mb-0">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary" data-dismiss="modal" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-scroll"></i> Request Form</button>
                        </div>
                        <span class="corner-border-bottom"></span>
                    </div>
                </div>
